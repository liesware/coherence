...
def ecc_pb(data_js):
	...
	print 'Keys (A): '+ json.dumps(answ)
	data_js_n=sending(json.dumps(req))
	answ_b=json.loads(data_js_n)
	print 'Keys (B): '+ json.dumps(answ_b)	 
...
curves_b=["sect571r1","sect571k1","sect409r1","sect409k1","sect283r1","sect283k1"]

curves_p=["brainpoolP512r1","secp521r1","brainpoolP384r1","secp384r1","brainpoolP320r1","brainpoolP256r1","secp256k1"]
