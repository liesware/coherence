...
cp lib/pistache/prefix/lib/libpistache.so.0.0.0* /lib/x86_64-linux-gnu/libpistache.so.0
cp lib/cryptopp/libcryptopp.so.8.2.0 /lib/x86_64-linux-gnu/libcryptopp.so.8
cp lib/libntru/libntru.so /lib/x86_64-linux-gnu/
cp lib/liboqs/build/lib/liboqs.so.0.0.0 /lib/x86_64-linux-gnu/liboqs.so.0
